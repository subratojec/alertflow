module github.com/alertflow/backend

go 1.26.0

require (
	github.com/prometheus/alertmanager v0.34.1-0.20260911081318-4b400e67d6da
	github.com/prometheus/common v0.71.1-0.20260913083349-f644b67e7338
